...
const ChatLayout = () => {
  return (
    <div className="flex h-screen bg-neutral-100 dark:bg-neutral-800 text-gray-700 transition duration-[300ms]">
      <div className="flex flex-col w-full min-w-[220px] sm:min-w-[240px] max-w-[23.5vw] border-neutral-300 border-r-[1px] dark:border-neutral-700 transition duration-[300ms]">
        <SideBarPanel />
        <GetAllChat />
      </div>
      <Outlet />
